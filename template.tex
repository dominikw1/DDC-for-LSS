...
use the System Level Synthesis (SLS) framework to generate a distributed model-predictive controller, which shares information only locally, the neighbourhood sizes being adjustable.
This is achieved through a locality constraint on the system response, the result of the SLS reformulation.
