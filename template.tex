...
A familty of techniques having been reserached deeply recently is the collection of Distributed Model Predictive Control methods.
...
In a DMPC setting, each subsystem solves a local MPC and exchanges certain pieces of information.
