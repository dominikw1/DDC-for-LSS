...
Factors that need to be considered in this design are communication delays and reliability. A general formulation of distributed control 
...
\begin{equation}
u_i = \kappa_i(x_i, \{\xi(x_j): j \in \mathcal{N}_i\})
\end{equation}
