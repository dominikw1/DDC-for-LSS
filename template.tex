...
Another interpolatory MOR technique is the AAA algorithm.    
% How does it work??



Balanced truncation (BT)~\cite{balancedtruncationOriginal} is a widely successfully employed MOR technique for large systems~\cite{salehi2021mixed}. 
...
the data-driven gradiant.

Proper orthogonal decomposition (POD) is ....

Dynamic Mode Decomposition is (DMD) ...
