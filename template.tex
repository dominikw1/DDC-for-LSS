...
\cite{zhang2023data} proposes a decentralised deep reinforcement learning approach with safety guaranteed by  embedded
safe policy projection, restricting the action space and avoiding constraint violation.
