...
such that safety constrants are respected and the modification is minimal, i.e. minimising 
...
HRL can be expressed as follows~\cite{naveed2021trajectory}, where \(Y\) denotes the Bellman Target:
...
Applying HRL naively to large scale systems can lead to computational inefficiency and convergence difficulties due to the inherent challenge of a high-dimensional action space,
