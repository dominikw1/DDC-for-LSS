...
the usage of advanced implementation techniques, such as using a sequence of 1-demensional Loewner matrices for the computation of the null-space of an \(n\)-dimensional one, as proposed in \cite{antoulas2024loewner},
